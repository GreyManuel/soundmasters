...
const forgotPasswordToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    await user.save();
    const resetURL = `Hi, Please follow this link to reset Your Password. This link is valid till 10 minutes from now. <a href='${import.meta.env.REACT_APP_API_ENDPOINT}/api/user/reset-password/${token}'>Click Here</>`;
    const data = {
      to: email,
      text: "Hey User",
